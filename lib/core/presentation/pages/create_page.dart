                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Crea un nuevo curso con contenido y actividades',
                              style: TextStyle(
                                fontSize: 14,
            ...
            Card(
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Get.snackbar('En desarrollo', 'Crear actividad desde aquí está en desarrollo. Úsalo desde un curso específico.',
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 4),
                            Text(
                              'Crea actividades y tareas para tus cursos',
                              style: TextStyle(
                                fontSize: 14,
                                color: Colors.grey.shade600,
                              ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 4),
                            Text(
                              'Ver, editar y eliminar categorías existentes',
                              style: TextStyle(
                                fontSize: 14,
                                color: Colors.grey.shade600,
                              ),
